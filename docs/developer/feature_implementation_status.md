...
- `[~]` Full evolution map layout is inspectable but not product-ready; it still
  needs richer time-slice matching, focus workflows, and larger-scale layout
  polish.
