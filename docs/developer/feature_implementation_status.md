...
- `[x]` Evolution lens supports compact/full loading profiles, truncation
  readouts, and URL-restorable `evolution_profile` state for larger artifact
  inspection.
