...
| F14 | Report, export, interoperability | `[~]` | 89% | HTML reports/viewer, dashboard export, GEXF, GraphML, VOSviewer-style map/network, static data, export manifest design, writer/validator, QA sidecars, first command adapters | web export bundles, thesaurus/rule-set exports, and richer view/filter metadata |
